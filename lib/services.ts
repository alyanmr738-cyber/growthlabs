...
export const services: Service[] = [
  {
    ...
    title: "Market Growth System for Growing Businesses | revenueflow",
    description:
    ...
    body: "Market Growth is the umbrella offer at revenueflow. We design how Google and Meta spend, how Google Tag Manager and conversion APIs report the truth, how GoHighLevel stores and routes the contact, and how automations plus AI chat and voice close the loop. You get a calendar that fills for a reason — not a dashboard of vanity metrics.",
    process: [
  ...
  },
  {
    ...
    title: "GoHighLevel Setup & CRM for Growing Businesses | revenueflow",
    description:
  ...
  },
  {
    ...
    title: "GoHighLevel Automations & Workflows | revenueflow",
    description:
    ...
    body: "Automations at revenueflow live inside GoHighLevel and connect to the events GTM and your ads platforms already send. Missed calls get a text. Form fills get an SMS and an email. No-shows get a recovery sequence. Reviews and reactivations stop being a manual Friday task.",
    process: [
      ...
      { title: "Testing", body: "We submit real test leads and walk the path on mobile and desktop." },
  ...
  },
  {
    ...
    navLabel: "AI Chatbot",
    title: "AI Chatbot & Conversation AI for GoHighLevel | revenueflow",
    description:
    ...
    body: "AI chat at revenueflow sits on your website, in GoHighLevel conversations, and on channels you already use. The bot qualifies against your script, writes the contact into the right pipeline, and can book. Handoff rules keep edge cases with your team.",
    process: [
      ...
      { title: "Role-play testing", body: "We attack the bot with messy questions until it stays on-brief." },
  ...
  },
  {
    ...
    title: "AI Voice Agent Setup for GoHighLevel | revenueflow",
    description:
  ...
  },
  {
    ...
    navLabel: "Google Ads",
    title: "Google Ads Lead Generation for Growing Businesses | revenueflow",
    description:
    ...
    body: "revenueflow structures Search and Performance Max around how your buyers search, then connects every conversion through Google Tag Manager, enhanced conversions, and offline import from the CRM. You stop teaching the algorithm that a junk lead is a win.",
    process: [
  ...
  },
  {
    ...
    navLabel: "GTM",
    title: "Google Tag Manager & Conversion Tracking | revenueflow",
    description:
    ...
    body: "Google Tag Manager is the unsexy page most GHL shops skip. revenueflow treats it as infrastructure: a clean data layer, GA4 events, Google Ads conversions, Meta Pixel plus Conversion API, and server-side or offline events from GoHighLevel when a lead is actually qualified or booked.",
    process: [
      ...
      { title: "Debug before launch", body: "Preview mode, Tag Assistant, and test conversions in each ads account before launch." },
    ],
    deliverables: [
  ...
  },
  {
    ...
    navLabel: "Meta Ads",
    title: "Meta Ads & Lead Ads into GoHighLevel | revenueflow",
    description:
    ...
    body: "revenueflow builds Meta campaign structure, creative tests, and Lead Forms that map into GoHighLevel fields. Instant SMS or Conversation AI fires. Meta CAPI — installed through GTM — tells Advantage+ which leads became bookings, not which names were cheapest.",
    process: [
    ...
    faq: [
      ...
      { q: "Can this sit next to Google Ads?", a: "Yes. Shared GTM events and a shared GHL pipeline are how we keep the two from competing on bad conversion data." },
    ],
